...
namespace AplicacionContable.Controllers
{
    public class InventariosController : Controller
    {
        ...
        {
            var _inventarios = db.vw_inventarios.ToList();
        ...
        [HttpPost]
        public ActionResult Create(inventarios_Model value)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(vw_inventarios_Model value)
        {
            try
            {
                //Se valida que el modelo no sea nulo.
            ...
            try
            {
                ...
                if (_inventario != null)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        //Guarda en bitacora.
                        var descripcion = $"Cliente activo: {_inventario.PK_codigo} - {_inventario.descripcion}.";
                        var FK_usuario = 1;
                        bt.Create(descripcion, FK_usuario);
        ...
        public ActionResult Libro_mayor(DateTime? fecha_inicio = null, DateTime? fecha_final = null)
        {
            ...
            {
                var _partidas = new List<vw_contabilidad_partidas_detalle_Model>();
                return Json(_partidas);
            }
        }
    }
