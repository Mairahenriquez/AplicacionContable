...
namespace AplicacionContable.Controllers
{
    public class ProveedoresOrdenesComprasController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(proveedores_ordenes_compras_Model value)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(vw_proveedores_ordenes_compras_Model value)
        {
            try
            {
                //Se valida que el modelo no sea nulo.
        ...
        public ActionResult Insert(proveedores_ordenes_compras_detalle_Model value)
        {
            try
            {
