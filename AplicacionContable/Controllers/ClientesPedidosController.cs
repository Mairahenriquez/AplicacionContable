...
namespace AplicacionContable.Controllers
{
    public class ClientesPedidosController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(clientes_pedidos_Model value)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(vw_clientes_pedidos_Model value)
        {
            try
            {
                //Se valida que el modelo no sea nulo.
        ...
        public ActionResult Insert(clientes_pedidos_detalle_Model value)
        {
            try
            {
