...
{
    [Table("vw_inventarios")]
    public class vw_inventarios_Model
    {
        [Key]
        ...
        public string cuenta_contable_inventarios { get; set; }
        public string cuenta_contable_costo_venta { get; set; }
        public string cuenta_contable_ingreso_venta { get; set; }
        public string cuenta_contable_devoluciones { get; set; }
